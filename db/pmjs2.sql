...
CREATE TABLE `cosubjectships` (
  ...
  `subject_id` mediumint(11) DEFAULT NULL,
  `cosubject_id` mediumint(11) DEFAULT NULL,
...
CREATE TABLE `journal_subjects` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `journal_id` mediumint(11) DEFAULT NULL,
  `year` smallint(11) DEFAULT '0',
  `subject_id` mediumint(11) DEFAULT NULL,
  `direct_articles_count` smallint(11) DEFAULT '0',
  `descendant_articles_count` mediumint(11) DEFAULT '0',
  `articles_count` mediumint(11) DEFAULT '0',
  PRIMARY KEY (`id`),
